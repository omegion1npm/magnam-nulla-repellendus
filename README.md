...
<p>
  <a aria-label="NPM version" href="https://www.npmjs.com/package/@omegion1npm/magnam-nulla-repellendus">
    <img alt="" src="https://img.shields.io/npm/v/@omegion1npm/magnam-nulla-repellendus.svg?style=for-the-badge&labelColor=0869B8">
  </a>
  <a aria-label="License" href="#">
    <img alt="" src="https://img.shields.io/npm/l/@omegion1npm/magnam-nulla-repellendus.svg?style=for-the-badge&labelColor=579805">
  </a>
  <a aria-label="Thinkmill Logo" href="https://www.thinkmill.com.au/open-source?utm_campaign=github-@omegion1npm/magnam-nulla-repellendus">
...
```bash
npm install @omegion1npm/magnam-nulla-repellendus
```

Use with [Node.js](https://nodejs.org/en/), [Browserify](https://browserify.org/), or [webpack](https://webpack.github.io/):

```js
const classNames = require('@omegion1npm/magnam-nulla-repellendus');
...
There is also a [Changelog](https://github.com/omegion1npm/magnam-nulla-repellendus/blob/master/HISTORY.md).
...
```js
import React, { useState } from 'react';
import classNames from '@omegion1npm/magnam-nulla-repellendus';
...
```js
const classNames = require('@omegion1npm/magnam-nulla-repellendus/dedupe');
...
```js
const classNames = require('@omegion1npm/magnam-nulla-repellendus/bind');
...
import classNames from '@omegion1npm/magnam-nulla-repellendus/bind';
